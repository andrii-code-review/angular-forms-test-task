...
import { CheckUserNameResponseData } from '../../services/user-name/user-name.api.entities';
...
export class MockBackendInterceptor implements HttpInterceptor {
  intercept(
    req: HttpRequest<any>,
    next: HttpHandler,
  ): Observable<HttpResponse<CheckUserNameResponseData | SubmitFormResponseData>> {
  ...
  private handleCheckUsername(
    req: HttpRequest<any>,
  ): Observable<HttpResponse<CheckUserNameResponseData>> {
